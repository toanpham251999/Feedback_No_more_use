...
public class QuestionAdp extends RecyclerView.Adapter<QuestionAdp.ViewHolder> {
   ...
   public QuestionAdp(ArrayList<Question> arrayListQuestion){
    ...
    @NonNull
    @Override
    public QuestionAdp.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       //Initalize view
       View view = LayoutInflater.from(parent.getContext())
               .inflate(R.layout.list_row_question, parent, false);
        return new QuestionAdp.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull QuestionAdp.ViewHolder holder, int position) {
